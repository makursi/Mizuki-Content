...
| 概念 | 定义位置 | 相关概念 |
|------|---------|---------|
| AI 辅助软件工程 | [§1.1](#11-传统软件工程-vs-ai-辅助软件工程) | TDD [§4.4], Pair Programming [§4.5], Deep Modules [§5.1] |
| 上下文窗口 | [§1.2](#12-llm-上下文窗口与-token-管理) | Smart Zone [§1.3], Dumb Zone [§1.3], Sub-Agent [§4.1] |
| Smart/Dumb Zone | [§1.3](#13-smart-zone-与-dumb-zone注意力衰减模型) | 切片粒度 [§3.3], Sub-Agent [§4.1], Token 管理 [§1.2] |

### 需求与规划概念

| 概念 | 定义位置 | 相关概念 |
|------|---------|---------|
| Client Brief | [§2.1](#21-client-brief-客户需求文档) | Grilling [§2.2], PRD [§3.1], Destination [§2.3] |
| Grilling Session | [§2.2](#22-grilling-session-需求追问) | Destination & Journey [§2.3], PRD [§3.1] |
| Destination & Journey | [§2.3](#23-destination--journey-文档化模式) | Grilling [§2.2], 上下文窗口 [§1.2], PRD [§3.1] |
| PRD 驱动开发 | [§3.1](#31-prd-驱动开发) | Client Brief [§2.1], Grilling [§2.2], Issues [§3.4] |
| 垂直切片 | [§3.2](#32-垂直切片-vs-水平切片) | Dumb Zone [§1.3], Kanban [§3.4], DAG [§4.2] |
| HITL / AFK | [§3.4](#34-kanban-与-hitlafk-任务分类) | Sub-Agent [§4.1], Kanban [§3.4], TDD [§4.4] |

### 实施与执行概念

| 概念 | 定义位置 | 相关概念 |
|------|---------|---------|
| Sub-Agent | [§4.1](#41-sub-agent-任务委派架构) | Dumb Zone [§1.3], DAG [§4.2], 垂直切片 [§3.2] |
| DAG 与 Phase | [§4.2](#42-依赖图-dag-与-phase-编排) | 垂直切片 [§3.2], parallel/pipeline [§4.3] |
| parallel/pipeline | [§4.3](#43-parallel-vs-pipeline-执行策略) | DAG [§4.2], Sub-Agent [§4.1] |
| TDD | [§4.4](#44-tdd-测试驱动开发循环) | Pair Programming [§4.5], PRD [§3.1], Deep Modules [§5.1] |
| Pair Programming | [§4.5](#45-pair-programming-人-ai-结对) | TDD [§4.4], AFK [§3.4] |

### 设计原则概念

| 概念 | 定义位置 | 相关概念 |
|------|---------|---------|
| Deep Modules | [§5.1](#51-deep-modules-定义与度量) | PRD [§3.1], Sub-Agent [§4.1], TDD [§4.4] |
| Clean Code vs Deep Modules | [§5.2](#52-deep-modules-vs-clean-code-对比) | Deep Modules [§5.1] |
| Skill 设计应用 | [§5.3](#53-ai-agentskill-设计中的-deep-modules) | Deep Modules [§5.1], Sub-Agent [§4.1] |
